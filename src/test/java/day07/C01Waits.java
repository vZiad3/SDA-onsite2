...
// Fluent Wait
    ...
    public void pageLoadTimeout() {
        driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(10));     // اذا ما اشتغل الموقع بعد ١٠ ثواني يقفله
   ...
   It is global, waits for all web elements.
    ...
    public void fluentWait() {
        ...
        //wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.id("butoon1")));
